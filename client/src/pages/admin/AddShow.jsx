...
import { kConverter } from '../../lib/kConvertner';
...
const AddShow = () => {
  ...
  return nowPlayingMovies.length > 0 ? (
    <>
      ...
      <p className='mt-10 text-lg font-medium'>Now Olaying Movies</p>
      ...
      <div className='mt-8'>
        <lable className="block text-sm font-medium mb-2">Show Price</lable>
        <div className='inline-flex items-center gap-2 border border-gray-600 px-3 py-2 rounded-md'>
          <p className='text-gray-400 text-sm'>{currency}</p>
          <input min={0} type="number" value={showPrice} onChange={(e) => setShowPrice(e.target.value)} placeholder="Enter show price " classnmae="outline-none" />
